...
for patient in  "chb12" "chb15" "chb01" "chb03"
do
	touch log/${patient}_recurrent_tscv.out
	touch log/${patient}_recurrent_tscv.err
	...
	--model gru\
	--batch-size 64\
	>log/${patient}_recurrent_tscv.out 2>log/${patient}_recurrent_tscv.err
done
